      ...
      <v-container>
        <v-row justify="center">
          <v-col
            ...
            lg="3"
            xl="4"
            v-for="(item, index) in shopItems[3]"
            :key="item"
            class="mb-4"
          >
            <v-card height="355" width="100%" elevation="3">
                    ...
                    <v-row>
                      ...
                      <v-col cols="6" class="text-center">
                        <v-icon
                          ...
                          @click="($event) => onLikeIconClick(index, 3)"
                        ></v-icon>
                      </v-col>
                    </v-row>
                  </v-card>
              ...
              <v-card-actions>
                <v-btn
                  ...
                  variant="outlined"
                  @click="($event) => onShowIconClick(index, 3)"
                >
                  <v-icon
                    color="purple-darken-4"
                    size="50"
                          ...
                          <v-row>
                            <v-col cols="3" class="ml-2"
                              ><v-btn
                                size="40"
                                color="purple-darken-4"
                                @click="($event) => selectNumber(index, 3, 1)"
                              >
